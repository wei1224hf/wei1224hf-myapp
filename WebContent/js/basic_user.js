		...
		if($.ligerui.get("formD")){
			...
			$(form).ligerForm({
				...
				,fields: [
					...
					,{ display: top.getIl8n('basic_user','type'), name: "basic_user__search_type", newline: true, type: "select", options :{data : basic_user.config.type, valueField : "code" , textField: "value" } }
					,{ display: top.getIl8n('basic_user','status'), name: "basic_user__search_status", newline: true, type: "select", options :{data : basic_user.config.status, valueField : "code" , textField: "value" } }
